...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_DEF] = LAYOUT(
          ...
          KC_LSFT, KC_Z,    X_CUT_,   C_COPY,  V_PASTE, KC_B,   OSM(MOD_MEH), OSM(MOD_HYPR), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          OSM(MOD_LALT), KC_LGUI, MO(_SYM), LT(_SYM,KC_SPC), LT(_NAV,KC_ENT), MO(_NAV), KC_BSPC, KC_RGUI
      ),
    //   [_GAMING] = LAYOUT(
    //       KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                                KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,
    ...
    //   ),
      [_SYM] = LAYOUT(
          ...
          _______, KC_CIRC, KC_SLSH, KC_ASTR, KC_BSLS, FLDR_UP, _______,           _______, KC_TILD, KC_LCBR, KC_RCBR, KC_DLR,  KC_QUES, _______,
                                     _______, _______, _______, _______,      LT(_ADJ,KC_ENT), MO(_ADJ),   _______, _______
      ),
      [_NAV] = LAYOUT(
          KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                               KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
          ...
          _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,           _______, KC_MPRV, KC_MNXT, KC_MPLY, XXXXXXX, XXXXXXX, _______,
                                     _______, _______, MO(_ADJ),LT(_ADJ,KC_SPC),   _______, _______, _______, _______
      ),
      [_ADJ] = LAYOUT(
...
void keyboard_post_init_user(void) {
    ...
    writePinHigh(24);
    // startup animation
    #ifdef JARI_CUSTOM_STARTUP
    rgb_matrix_enable_noeeprom();
    rgb_matrix_set_color_all(0, 0, 128);
    int leds_per_half = RGB_MATRIX_LED_COUNT / 2;
    for (int i=0; i<leds_per_half; i++) {
        rgb_matrix_set_color(i, 128, 0, 0);
        rgb_matrix_set_color(i + leds_per_half, 128, 0, 0);
        rgb_matrix_update_pwm_buffers();
        wait_ms(50);
        rgb_matrix_set_color(i, 0, 0, 0);
        rgb_matrix_set_color(i + leds_per_half, 0, 0, 0);
        rgb_matrix_update_pwm_buffers();
    }
    wait_ms(100);
    #endif
